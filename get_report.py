...
selected_client = st.sidebar.selectbox(
    "Select client:",
    ["Melonn", "Amoblando Pullman", "Bogota test client", "La Mansion", "Sutex", "Laika", "Loto del Sur", "All clients"]
)
...
def get_cached_report(client_option, period):
    ...
    if option == "Monthly":
        report = get_report(client_option, period, start_="2023-05-01", end_="2023-06-30")
    else:
...
switch=True
download_enabled = st.checkbox("enable download", value=switch)
if download_enabled:
